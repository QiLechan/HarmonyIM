package com.yuezhikong.harmonyim;

import static cn.hutool.core.io.resource.ResourceUtil.getResources;
import static com.yuezhikong.harmonyim.ConfigFile.ProtocolVersion;
...
import com.yuezhikong.harmonyim.Encryption.KeyData;
import com.yuezhikong.harmonyim.Encryption.RSA;
import com.yuezhikong.harmonyim.Protocol.ProtocolData;
...
public class MainActivity extends Ability {
    ...
    {
        getUITaskDispatcher(()-> Toast.makeText(MainActivity.this,getResources().getString(id),Toast.LENGTH_LONG).show());
    }

    public void ClearScreen(Component view) {
        getUITaskDispatcher(()->{
            Text SocketDisplay = findComponentById(ResourceTable.id.ChatLog);
        ...
        if (!Session)
        {
            ...
            Runnable NetworkThread = () ->
            {
                try {
                    ...
                    getUITaskDispatcher(()-> SocketOutput.setText(String.format("%s\r\n服务器响应：%s",SocketOutput.getText(), finalDecryptStr1)));
